...
public interface AdminRepository extends CrudRepository <Admin, Integer> {
    ...
    String QueryGerirMonitor= "INSERT INTO campo_semana (semana_id, monitor_id, campo_id) values (:semana,:monitor,:campo)";
    ...
    List<Admin> gerirMonitor (@Param("semana") int  id, @Param ("monitor") int monitorid, @Param ("campo") int campoid);
